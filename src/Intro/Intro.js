    ...
    <div>
      ...
      <g id="scene3">
          ...
          <g id="fstar">
              ...
              <circle id="fstar_circle" cx="768.6" cy="78.72" r="39.39" transform="translate(64.22 396.2) rotate(-30.11)"
                  fill="url(#fstar-grad)" />
          </g>

          <g id="info2">
            <foreignObject x="30%" y="150" dominantBaseline="middle" width="300" height="600">
                ...
                <div className="wrapper">
                  ...
                  <div className="form-container">
                      <div className="slide-controls">
                          <input type="radio" name="slide" id="login" checked={true}/>
      ...
      <g id="scene1">
          <g id="hills1">
              ...
              <path id="h1-4"
                  ...
                  fill="url(#grad6)" />
                <g id="info">
                  <text x="34%" y="300" fontSize="70" fontFamily="Bebas Neue">STAR MARK</text>
                </g>
